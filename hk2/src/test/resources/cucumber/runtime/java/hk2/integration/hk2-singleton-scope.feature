Feature: cucumber-hk2 supports singleton scope

  Scenario: cucumber-hk2 provides a singleton scope instance to multiple steps within the same scenario
  ...
  Scenario: cucumber-hk2 provides the same instance for each scenario when singleton scope is specified for the object
