Feature: cucumber-hk2 supports scenario scope

  Scenario: cucumber-hk2 provides a scenario scope instance to multiple steps within the same scenario
  ...
  Scenario: cucumber-hk2 provides a new instance for each scenario when scenario scope is specified for the object
