...
public interface LambdaGlueBase extends GlueBase {
    ...
    default Glue getGlue() {
        return JavaBackend.GLUE.get();
    }

    default void Before(final HookBody body) {
        JavaBackend.INSTANCE.get().addBeforeHookDefinition(getGlue(), new Java8HookDefinition(EMPTY_TAG_EXPRESSIONS, DEFAULT_BEFORE_ORDER, NO_TIMEOUT, body));
    }

    default void Before(String[] tagExpressions, final HookBody body) {
        JavaBackend.INSTANCE.get().addBeforeHookDefinition(getGlue(), new Java8HookDefinition(tagExpressions, DEFAULT_BEFORE_ORDER, NO_TIMEOUT, body));
    }

    default void Before(long timeoutMillis, final HookBody body) {
        JavaBackend.INSTANCE.get().addBeforeHookDefinition(getGlue(), new Java8HookDefinition(EMPTY_TAG_EXPRESSIONS, DEFAULT_BEFORE_ORDER, timeoutMillis, body));
    }

    default void Before(int order, final HookBody body) {
        JavaBackend.INSTANCE.get().addBeforeHookDefinition(getGlue(), new Java8HookDefinition(EMPTY_TAG_EXPRESSIONS, order, NO_TIMEOUT, body));
    }
    ...
    default void BeforeStep(final HookBody body) {
        JavaBackend.INSTANCE.get().addBeforeStepHookDefinition(getGlue(),new Java8HookDefinition(EMPTY_TAG_EXPRESSIONS, DEFAULT_BEFORE_ORDER, NO_TIMEOUT, body));
    }

    default void BeforeStep(String[] tagExpressions, final HookBody body) {
        JavaBackend.INSTANCE.get().addBeforeStepHookDefinition(getGlue(),new Java8HookDefinition(tagExpressions, DEFAULT_BEFORE_ORDER, NO_TIMEOUT, body));
    }

    default void BeforeStep(long timeoutMillis, final HookBody body) {
        JavaBackend.INSTANCE.get().addBeforeStepHookDefinition(getGlue(),new Java8HookDefinition(EMPTY_TAG_EXPRESSIONS, DEFAULT_BEFORE_ORDER, timeoutMillis, body));
    }

    default void BeforeStep(int order, final HookBody body) {
        JavaBackend.INSTANCE.get().addBeforeStepHookDefinition(getGlue(),new Java8HookDefinition(EMPTY_TAG_EXPRESSIONS, order, NO_TIMEOUT, body));
    }

    default void BeforeStep(String[] tagExpressions, long timeoutMillis, int order, final HookBody body) {
        JavaBackend.INSTANCE.get().addBeforeStepHookDefinition(getGlue(),new Java8HookDefinition(tagExpressions, order, timeoutMillis, body));
    }
    ...
    default void After(String[] tagExpressions, final HookBody body) {
        JavaBackend.INSTANCE.get().addAfterHookDefinition(getGlue(), new Java8HookDefinition(tagExpressions, DEFAULT_AFTER_ORDER, NO_TIMEOUT, body));
    }

    default void After(long timeoutMillis, final HookBody body) {
        JavaBackend.INSTANCE.get().addAfterHookDefinition(getGlue(), new Java8HookDefinition(EMPTY_TAG_EXPRESSIONS, DEFAULT_AFTER_ORDER, timeoutMillis, body));
    }

    default void After(int order, final HookBody body) {
        JavaBackend.INSTANCE.get().addAfterHookDefinition(getGlue(), new Java8HookDefinition(EMPTY_TAG_EXPRESSIONS, order, NO_TIMEOUT, body));
    }
    ...
    default void AfterStep(final HookBody body) {
        JavaBackend.INSTANCE.get().addAfterStepHookDefinition(getGlue(),new Java8HookDefinition(EMPTY_TAG_EXPRESSIONS, DEFAULT_AFTER_ORDER, NO_TIMEOUT, body));
    }

    default void AfterStep(String[] tagExpressions, final HookBody body) {
        JavaBackend.INSTANCE.get().addAfterStepHookDefinition(getGlue(),new Java8HookDefinition(tagExpressions, DEFAULT_AFTER_ORDER, NO_TIMEOUT, body));
    }

    default void AfterStep(long timeoutMillis, final HookBody body) {
        JavaBackend.INSTANCE.get().addAfterStepHookDefinition(getGlue(),new Java8HookDefinition(EMPTY_TAG_EXPRESSIONS, DEFAULT_AFTER_ORDER, timeoutMillis, body));
    }

    default void AfterStep(int order, final HookBody body) {
        JavaBackend.INSTANCE.get().addAfterStepHookDefinition(getGlue(),new Java8HookDefinition(EMPTY_TAG_EXPRESSIONS, order, NO_TIMEOUT, body));
    }

    default void AfterStep(String[] tagExpressions, long timeoutMillis, int order, final HookBody body) {
        JavaBackend.INSTANCE.get().addAfterStepHookDefinition(getGlue(),new Java8HookDefinition(tagExpressions, order, timeoutMillis, body));
    }
