...
public class Java8LambdaStepDefinitionTest {
    ...
    public void should_calculate_parameters_count_from_body_with_one_param() throws Exception {
        ...
        Java8StepDefinition def = new Java8StepDefinition("^I have (\\d) some step (.*)$", 0, StepdefBody.A1.class, body, parameterTypeRegistry);
    ...
    public void should_calculate_parameters_count_from_body_with_two_params() throws Exception {
        ...
        Java8StepDefinition def = new Java8StepDefinition("^I have some step $", 0, StepdefBody.A2.class, body, parameterTypeRegistry);
    ...
    public void should_fail_for_param_with_non_generic_list() throws Exception {
        try {
            ...
            new Java8StepDefinition("^I have (\\d) some step (.*)$", 0, StepdefBody.A1.class, body, parameterTypeRegistry);
