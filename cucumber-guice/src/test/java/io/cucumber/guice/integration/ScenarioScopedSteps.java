...
@ScenarioScoped
final class ScenarioScopedSteps {
    ...
    @Inject
    ScenarioScopedSteps(Provider<ScenarioScopedObject> scenarioScopedObjectProvider) {
    ...
    void a_scenario_scope_instance_has_been_provided_in_this_scenario() {
        OBJECTS.clear();
        provide();
    }
    ...
    void another_scenario_scope_instance_is_provided() {
        provide();
    }

    @Then("all three provided instances are the same instance")
    void all_three_provided_instances_are_the_same_instance() {
    ...
    void a_scenario_scope_instance_was_provided_in_the_previous_scenario() {
    ...
    void the_two_provided_instances_are_different() {
