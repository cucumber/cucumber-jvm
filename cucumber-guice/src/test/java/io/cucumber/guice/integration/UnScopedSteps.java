...
final class UnScopedSteps {
    ...
    @Inject
    UnScopedSteps(Provider<UnScopedObject> unScopedObjectProvider) {
        this.unScopedObjectProvider = unScopedObjectProvider;
    }

    @Given("an un-scoped instance has been provided in this scenario")
    void an_un_scoped_instance_has_been_provided_in_this_scenario() {
        OBJECTS.clear();
        provide();
    }
    ...
    void another_un_scoped_instance_is_provided() {
        provide();
    }

    @Then("all three provided instances are unique instances")
    void all_three_provided_instances_are_unique_instances() {
