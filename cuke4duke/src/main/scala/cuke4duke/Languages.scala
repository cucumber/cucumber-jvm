...
trait RomanianDiacritical { this: ScalaDsl =>
  val Dacă = new Step("Dacă")
  val Când = new Step("Când")
  val Atunci = new Step("Atunci")
}
trait Latvian { this: ScalaDsl =>
  val Kad = new Step("Kad")
  val Ja = new Step("Ja")
  val Tad = new Step("Tad")
}
trait Croatian { this: ScalaDsl =>
