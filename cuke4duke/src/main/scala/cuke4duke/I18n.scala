...
trait ZH_CN { this: ScalaDsl =>
  val 假如 = new Step("假如")
  val 当 = new Step("当")
  val 那么 = new Step("那么")
}
trait ZH_TW { this: ScalaDsl =>
  val 假設 = new Step("假設")
  val 當 = new Step("當")
  val 那麼 = new Step("那麼")
}
