...
public class JavaDefaultParameterTransformerDefinitionTest {
    ...
    public void must_have_non_void_return() throws Throwable {
        ...
        CucumberException exception = assertThrows(CucumberException.class, () -> new JavaDefaultParameterTransformerDefinition(method, lookup));
    ...
    public void must_have_two_arguments() throws Throwable {
        ...
        assertThrows(CucumberException.class, () -> new JavaDefaultParameterTransformerDefinition(oneArg, lookup));
        ...
        assertThrows(CucumberException.class, () -> new JavaDefaultParameterTransformerDefinition(threeArg, lookup));
    }
