...
```xml
    <dependency org="info.cukes" name="cucumber-core" rev="1.0.6"/>
```
...
* http://cukes.info/cucumber/jvm/api/1.0.6
...
```
mvn release:clean
mvn --batch-mode -P release-sign-artifacts release:prepare -DautoVersionSubmodules=true -DdevelopmentVersion=1.0.7-SNAPSHOT
