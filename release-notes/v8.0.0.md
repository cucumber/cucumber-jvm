...
JUnit, Jackson, Spring and AssertJ. It appears the industry has moved on and I
don't expect this will pose serious problems to anyone.
...
Cucumber will log a warning if your class path scanning could be improved.
...
Note: This is a work in progress. While Cucumber-JVM can run these steps the
reporting hasn't caught up yet.

Cucumber-TestNG and Cucumber-JUnit have been deprecated
-------------------------------------------------------
...
the introduction of the JUnit Platform things look differently.

```mermaid
erDiagram
    "Eclipse" ||--|{ "cucumber-core" : ""
    "IDEA" ||--|{ "CLI" : ""
    "CLI" ||--|{ "cucumber-core" : ""
...
As of v3.6.0 Maven Surefire uses the JUnit Platform exclusively and Gradle
v9.4.0 supports the discovery of resource based tests on the JUnit Platform. 
This removes the need to keep `cucumber-junit` for JUnit 4 and `cucumber-testng`
around. Removing these and after some refactoring will then allow Cucumbers
architecture to be simplified significantly: 
...
With this in mind `cucumber-testng` and `cucumber-junit` (for JUnit 4) have been
deprecated. Please switch to the [cucumber-junit-platform-engine](https://github.com/cucumber/cucumber-jvm/tree/main/cucumber-junit-platform-engine).
