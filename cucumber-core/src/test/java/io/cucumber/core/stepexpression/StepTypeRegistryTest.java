...
// private final ExpressionFactory expressionFactory = new
// ExpressionFactory(registry.parameterTypeRegistry());
//
// @Test
...
// DocStringType expected = new DocStringType(JsonNode.class, "json", (String s)
// -> null);
