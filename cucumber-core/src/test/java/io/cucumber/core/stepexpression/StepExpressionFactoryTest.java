...
// UUID::randomUUID);
// private final StepTypeRegistry registry = new
// StepTypeRegistry(Locale.ENGLISH);
// private final StepExpressionFactory stepExpressionFactory = new
// StepExpressionFactory(registry, bus);
...
// StepDefinition stepDefinition = new StubStepDefinition("Given a
...
// (map, valueType, tableCellByTypeTransformer) ->
// objectMapper.convertValue(map,
