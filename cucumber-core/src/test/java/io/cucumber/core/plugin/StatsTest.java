...
// Stats stats = new Stats(query, Locale.US);
...
// counter.addStep(Status.PASSED);
// counter.addStep(Status.PASSED);
// counter.addScenario(Status.PASSED, createTestCase("classpath:com/example",
// 42, "scenario designation"));
// counter.printStats(new PrintStream(baos));
//
// assertThat(baos.toString(), startsWith(String.format(
...
// @Test
// void
// should_print_sub_counts_in_order_failed_ambiguous_skipped_pending_undefined_passed()
// {
// Stats counter = createMonochromeSummaryCounter();
// ByteArrayOutputStream baos = new ByteArrayOutputStream();
//
...
// "6 Scenarios (1 failed, 1 ambiguous, 1 skipped, 1 pending, 1 undefined, 1
// passed)%n" +
// "6 Steps (1 failed, 1 ambiguous, 1 skipped, 1 pending, 1 undefined, 1
// passed)%n")));
// }
//
// private void addOneStepScenario(Stats counter, Status status) {
// counter.addStep(status);
// counter.addScenario(status, createTestCase("classpath:com/example", 14,
// "scenario designation"));
// }
//
// @Test
// void
// should_print_sub_counts_in_order_failed_ambiguous_skipped_undefined_passed_in_color()
// {
...
// return new Stats(query, Locale.US);
// }
//
// @Test
...
// Stats counter = new Stats(query, Locale.GERMANY);
// ByteArrayOutputStream baos = new ByteArrayOutputStream();
//
// counter.setStartTime(ANY_TIME);
// counter.setFinishTime(ANY_TIME.plus(ofMinutes(1)).plus(ofSeconds(1)).plus(ofMillis(1)));
...
// counter.addScenario(Status.FAILED, createTestCase("path/file.feature", 3,
// "Scenario: scenario_name"));
// counter.addStep(Status.AMBIGUOUS);
// counter.addScenario(Status.AMBIGUOUS, createTestCase("path/file.feature", 3,
// "Scenario: scenario_name"));
// counter.addStep(Status.UNDEFINED);
// counter.addScenario(Status.UNDEFINED, createTestCase("path/file.feature", 3,
// "Scenario: scenario_name"));
// counter.addStep(Status.PENDING);
// counter.addScenario(Status.PENDING, createTestCase("path/file.feature", 3,
// "Scenario: scenario_name"));
// counter.printStats(new PrintStream(baos));
//
// assertThat(baos.toString(), startsWith(String.format("" +
