 ...
 * Correct factory is selected according to the name part {@link #getName()}.
 * The argument is passed to {@link #create(String)}, {@code null} if no argument was provided.
 * <p>
 * To add more, implement {@link PickleOrderFactory} and register it for {@link java.util.ServiceLoader}.
 * The factory is creating instance of {@link PickleOrder}, responsible for ordering pickles.
 *
 */
