...
public final class TestNGFormatterOld implements EventListener {
    ...
    public TestNGFormatterOld(OutputStream out) {
    ...
    private void handleTestRunFinished(TestRunFinished event) {
        try {
            ...
            suite.setAttribute("name", TestNGFormatterOld.class.getName());
            suite.setAttribute("duration-ms", String.valueOf(duration.toMillis()));
            test.setAttribute("name", TestNGFormatterOld.class.getName());
