...
public class StepDefinitionMatchTest {
    ...
    public void shouldConvertParameters() throws Throwable {
        ...
        StepDefinitionMatch stepDefinitionMatch = new StepDefinitionMatch(arguments, stepDefinition, "some.feature", stepWithoutDocStringOrTable, new ConverterLookups());
