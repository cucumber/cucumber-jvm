...
public class StepDefinitionMatchTest {
    ...
    public static class TableAndDocString {
        ...
        public void method(int aInt, List<String> table, List<String> doc) {
            called = true;
        }
    }
    ...
    public void should_handle_doc_strings_and_row_together() throws Throwable {
        ...
        Step step = new Step(null, "Given ", "I have 4 cukes in my belly", 1, Arrays.asList( row1, row2 ), new DocString( "string", "blabla", 1 ));

        TableAndDocString target = new TableAndDocString();
        StepDefinition stepDefinition = new StubStepDefinition(target, TableAndDocString.class.getMethod("method", Integer.TYPE, List.class, List.class), "some pattern");
        StepDefinitionMatch stepDefinitionMatch = new StepDefinitionMatch(asList(new Argument(7, "4")), stepDefinition, null, step, new LocalizedXStreams(getClass().getClassLoader()));
