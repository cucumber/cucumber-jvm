...
public class RuntimeOptionsFactoryTest {
    ...
    public void create_without_options() {
        ...
        Plugins plugins = new Plugins(getClass().getClassLoader(), new PluginFactory(), new DefaultEventBus(TimeService.SYSTEM), runtimeOptions);
    ...
    public void inherit_plugin_from_baseclass() {
        ...
        RuntimeOptions runtimeOptions = runtimeOptionsFactory.create();
        List<Plugin> plugins = new Plugins(getClass().getClassLoader(), new PluginFactory(), new DefaultEventBus(TimeService.SYSTEM), runtimeOptions).getPlugins();
