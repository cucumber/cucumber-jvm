...
class TimelineFormatterTest {
    ...
    void shouldWriteAllRequiredFilesToOutputDirectory() throws IOException {
        ...
        final List<String> files = Arrays.asList("index.html", "formatter.js", "jquery-3.5.1.min.js",
            "vis-timeline-graph2d.min.css", "vis-timeline-graph2d.min.js", "vis-timeline-graph2d.override.css");
