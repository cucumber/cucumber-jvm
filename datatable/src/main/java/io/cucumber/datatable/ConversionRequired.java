...
final class ConversionRequired implements TableConverter {
    ...
    public <T> T convert(DataTable dataTable, Type type, boolean transposed) {
        throw new CucumberDataTableException(
            "Can't convert DataTable to %s. You have to write the conversion for it in this method"
                    .formatted(type));
    }
    ...
    public <T> List<T> toList(DataTable dataTable, Type itemType) {
        throw new CucumberDataTableException(
            "Can't convert DataTable to List<%s>. You have to write the conversion for it in this method"
                    .formatted(itemType));
    }
