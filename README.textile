...
cuke4duke lets you write Cucumber steps in pure Java. Example:
...
cuke4duke also brings you first-class Maven support.
...
Now head to the simple example and run it. It serves well as a testbed. Or simply <code>mvn clean install -Pexamples -Dcucumber.installGems=true</code>
