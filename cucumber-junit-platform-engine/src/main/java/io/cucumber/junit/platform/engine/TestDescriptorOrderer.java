...
abstract class TestDescriptorOrderer  {

    private static final Logger log = LoggerFactory.getLogger(TestDescriptorOrderer.class);

    private static final Pattern RANDOM_AND_SEED_PATTERN = Pattern.compile("random(?::(\\d+))?");

    static TestDescriptorOrderer parse(String argument) {
